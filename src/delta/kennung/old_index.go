...
func (i *oldIndex) AddHinweis(h Hinweis) (err error) {
...
func (i *oldIndex) CreateHinweis() (h Hinweis, err error) {
	if err = i.readIfNecessary(); err != nil {
		err = errors.Wrap(err)
		return
	}
...
func (i *oldIndex) makeHinweisButDontStore(j int) (h Hinweis, err error) {
	k := &coordinates.Kennung{}
...
func (i *oldIndex) PeekHinweisen(m int) (hs []Hinweis, err error) {
	if err = i.readIfNecessary(); err != nil {
		err = errors.Wrap(err)
		return
	}
