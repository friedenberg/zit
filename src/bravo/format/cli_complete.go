...
//type CliComplete.go struct {
//	wBuf    *bufio.Writer
//	chNamed chan Named
//	chDone  chan struct{}
//}

//func MakeCliComplete.go(w io.Writer) WriterComplete {
//	w1 := CliComplete.go{
...
//func (w *CliComplete.go) WriteZettelNamed(z *Named) (err error) {
//	select {
//	case <-w.chDone:
//		err = io.EOF
...
//func (w *CliComplete.go) Close() (err error) {
//	close(w.chNamed)
//	<-w.chDone
