...
type SetPrefixTransacted struct {
	innerMap map[etikett.Etikett]SetTransacted
}

type SetPrefixTransactedSegments struct {
	Ungrouped SetTransacted
	Grouped   SetPrefixTransacted
}

func MakeSetPrefixTransacted(c int) (s SetPrefixTransacted) {
	s.innerMap = make(map[etikett.Etikett]SetTransacted, c)
	return s
}

//TODO mark that this splits on right-expanded
func (s *SetPrefixTransacted) Add(z zettel_transacted.Zettel) {
...
func (s SetPrefixTransacted) addPair(e etikett.Etikett, z zettel_transacted.Zettel) {
...
func (a SetPrefixTransacted) Each(f func(etikett.Etikett, SetTransacted) error) (err error) {
...
func (a SetPrefixTransacted) EachZettel(f func(etikett.Etikett, zettel_transacted.Zettel) error) (err error) {
	return a.Each(
...
func (s SetPrefixTransacted) ToSetTransacted() (out SetTransacted) {
