...
func (s *probe_index) ReadOneObjectSha(sh *sha.Sha) (sk *sku.Transacted, err error) {
...
func (s *probe_index) ReadOneObjectIdSha(
...
func (s *probe_index) ReadOneObjectId(
	k interfaces.ObjectId,
...
func (s *probe_index) makeWriteMetadateiFunc(
	dir string,
...
func (s *probe_index) MakeFuncSaveOneVerweise(o *sku.Transacted) func() error {
	return func() (err error) {
		k := o.GetObjectId()
