...
var poolId interfaces.Pool[Id, *Id]

func init() {
	poolId = pool.MakePool(
		nil,
		func(k *Id) {
			k.Reset()
		},
...
func GetIdPool() interfaces.Pool[Id, *Id] {
	return poolId
}
...
func (a *Id) Clone() (b *Id) {
	b = GetIdPool().Get()
	b.ResetWithIdLike(a)
	return
}

func MustId(kp IdLike) (k *Id) {
	k = &Id{}
...
func (k2 *Id) WriteTo(w io.Writer) (n int64, err error) {
...
func (k2 *Id) ReadFrom(r io.Reader) (n int64, err error) {
	var n1 int64
...
func (k2 *Id) SetGenre(g interfaces.GenreGetter) {
	if g == nil {
...
func (k2 *Id) StringFromPtr() string {
...
func (k2 *Id) GetHeadAndTail() (head, tail string) {
	head = k2.left.String()
...
func (k2 *Id) LenHeadAndTail() (int, int) {
	return k2.left.Len(), k2.right.Len()
}

func (k2 *Id) String() string {
...
func (k2 *Id) PartsStrings() IdParts {
	return IdParts{
		Left:   &k2.left,
		Middle: k2.middle,
		Right:  &k2.right,
...
func (k2 *Id) GetGenre() interfaces.Genre {
	return k2.g
}
...
func (k2 *Id) SetFromPath(
	...
	switch ext {
	case fe.Etikett:
		if err = k2.SetWithGenre(els[1], gattung.Etikett); err != nil {
			err = errors.Wrap(err)
			return
		}

	case fe.Typ:
		if err = k2.SetWithGenre(els[1], gattung.Typ); err != nil {
			err = errors.Wrap(err)
			return
		}

	case fe.Kasten:
		if err = k2.SetWithGenre(els[1], gattung.Kasten); err != nil {
			err = errors.Wrap(err)
			return
		}
	...
	case fe.Zettel:
		...
		if err = k2.SetWithGenre(els[2]+"/"+els[1], gattung.Zettel); err != nil {
			err = errors.Wrap(err)
			return
		}
...
func (h *Id) TodoSetBytes(v *catgut.String) (err error) {
	return h.Set(v.String())
}

func (h *Id) SetRaw(v string) (err error) {
	h.g = gattung.Unknown
...
func (h *Id) Set(v string) (err error) {
	var k IdLike
...
func (a *Id) ResetWithIdLike(b IdLike) (err error) {
	return a.SetWithIdLike(b)
}

func (t *Id) MarshalText() (text []byte, err error) {
	text = []byte(FormattedString(t))
	return
}

func (t *Id) UnmarshalText(text []byte) (err error) {
...
func (t *Id) MarshalBinary() (text []byte, err error) {
...
func (t *Id) UnmarshalBinary(text []byte) (err error) {
	if err = t.Set(string(text)); err != nil {
		err = errors.Wrap(err)
		return
	}
